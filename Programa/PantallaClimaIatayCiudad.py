...
def pantalla_clima_iata_ciudad(window, pantalla_principal, entrada_usuario):
    ...
    Subtitulo = Label(frame_desliz, text=f"Mostrando resultados para {buscador.obtener_nombre_ciudad(entrada_usuario)}", font=("Montserrat", 22, "italic"), fg="#011640")
    ...
    window.BotonRegreso = PhotoImage(file=os.path.join(carpeta_img, 'BotonRegreso.png')).subsample(2, 2)  
